...
const LoginPage = () => {
  return (
    <>
      <Helmet>
        <title>LOGIN - FRUITS SHOP</title>
        <meta name="description" content="LOGIN - FRUITS SHOP" />
        <meta property="og:title" content="LOGIN - FRUITS SHOP" />
        <meta property="og:description" content="LOGIN - FRUITS SHOP" />
        <meta
          property="og:image"
          ...
          <div className="col-md-4 mx-auto">
            <form>
              ...
              <div className="my-3">
                <p>
                  New Here?{" "}
                  <Link to="/register" className="underline text-cyan-400">
                    Register
                  </Link>{" "}
                </p>
              </div>
